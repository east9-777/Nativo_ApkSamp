...
SplashScreen::SplashScreen()
{
	int x = rand() % 2;
	switch (x) {
		case 0: m_logo = new Image("menu", "menu_adjback");
			break;

		case 1: m_logo = new Image("menu", "menu_adjback2");
			break;
	}

	this->addChild(m_logo);

	m_progressBar = new ProgressBar(ImColor(0.0f, 0.0f, 0.0f), ImColor(190, 0, 0), ImColor(255, 100, 0), ImColor(255, 100, 0), ImColor(190, 0, 0));
